...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "LISTA DOS MENUS","footerText": "tmj maninhos e maninhas❤️","listType": "SINGLE_SELECT","sections": list}}, {})
...
╠➥𝙪𝙨𝙚𝙧: ${pushname}
║
╠➥𝙨𝙩𝙖𝙩𝙪𝙨: ${isOwner ? 'OWNER' : isPremium ? 'Premium' : 'Nao detctado'}
║
╠➥𝙗𝙖𝙩𝙚𝙧𝙞𝙖: ${baterai}% 
║
╠➥𝙥𝙧𝙚𝙛𝙞𝙭: multi prefix
...
╚═════════════
`
               buttons = [{buttonId: `${prefix}command`,buttonText:{displayText: 'MENUS😈'},type:1},{buttonId: `${prefix}vn`,buttonText:{displayText: 'MENU DE ÁUDIO🗣️'},type:1},{buttonId: `${prefix}owner`,buttonText:{displayText: 'CRIADOR/DONO👤️'},type:1}]
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '𝙖𝙥𝙧𝙤𝙫𝙚𝙞𝙩𝙚 𝙤 𝙗𝙤𝙩', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
case 'waifu':
          ...
          case 'wallml':
		      ...
		      buttons = [{buttonId: `lloli`,buttonText:{displayText: `➡️𝙋𝙍𝙊𝙎𝙄𝙈𝘼`},type:1}]
              ...
              contentText:`𝙑𝘼𝙄 𝘽𝘼𝙏𝙀𝙍 𝙐𝙈𝘼 𝙋𝙍𝘼 2𝘿 𝙈𝘼𝙉𝙊?`,buttons,headerType:4}
...
//------------------< Premium >-------------------
       ...
       case 'buypremium':
       case 'sewabot':
              gopeynya = 'https://i.ibb.co/ynkbMf2/20211125-185752.jpg'
              teksnya = `*[ PRICE LIST ]*
...
//------------------< Ingfo Bot >-------------------
      ...
      case 'speed':
              ...
              reply(`「 *𝙏𝙀𝙎𝙏𝙀 𝘿𝙀 𝙑𝙀𝙇𝙊𝘾𝙄𝘿𝘼𝘿𝙀* 」\n𝙫𝙚𝙡𝙤𝙘𝙞𝙙𝙖𝙙𝙚 𝙙𝙚 𝙧𝙚𝙨𝙥𝙤𝙨𝙩𝙖 𝙙𝙤 𝙗𝙤𝙩 ${latensie.toFixed(4)} Sec 💬`)
              break
      case 'botstat':
...
case 'linkgc':
            ...
            case 'ban':
             ...
             break
case 'promote':
             reply('A não mais uma porra de adm pra mandar em mim , sabia isso e trabalho escravo o fpt , promovodo🛐 ')
             if (!isGroupAdmins) return reply(mess.only.admin)
             ...
             CalMeHerman.js.groupMakeAdmin(from, mems_ids)
             } else {
             CalMeHerman.js.groupMakeAdmin(from, entah)
}
             } else {
...
//------------------< enable/disable>-------------------
       ...
       case 'welcome':
               ...
               reply('Enable para ativar , disable pra desativar ')
}
               break
        case 'mute':
               if (!isGroup) return reply(mess.only.group)
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
         ...
         case 'pulsa':
             ...
             break       
      case 'grpc':
             reply(`Entra ai :\n https://chat.whatsapp.com/HejDb5bOZCl4NJFrGJGTFg`)
             break      
      case 'infoig':
